...
type NodoServiceClient interface {
	...
	Replicar(ctx context.Context, in *Logs, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *nodoServiceClient) Replicar(ctx context.Context, in *Logs, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type NodoServiceServer interface {
	...
	Replicar(context.Context, *Logs) (*Empty, error)
...
func (UnimplementedNodoServiceServer) Replicar(context.Context, *Logs) (*Empty, error) {
