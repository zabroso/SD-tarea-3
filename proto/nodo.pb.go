...
func (*Logs) Descriptor() ([]byte, []int) {
	return file_nodo_proto_rawDescGZIP(), []int{9}
}
...
var file_nodo_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
